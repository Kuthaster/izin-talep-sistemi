...
final departmentApproversRepositoryProvider = Provider<DepartmentApproverRepository>((ref) {
  final dioClient = ref.read(dioClientProvider);
  return DepartmentApproverRepository(dioClient);
});


final departmentApproverFamily = FutureProvider.family<DepartmentApprover, int>((ref, departmentId) async {
