...
class DepartmentApproverService {
   ...
   Future<List<DepartmentApprover>> getApproversForDepartment() async {
        final response = await DioClient().dio.get('/api/admin/departmentApprovers');
  ...
  Future<List<DepartmentApprover>> assignApprover(DepartmentApproverAssign dto) async {
