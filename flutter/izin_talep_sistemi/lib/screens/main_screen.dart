...
import 'package:izin_talep_sistemi/screens/my_requests_for_approval_screen.dart';
    ...
    body: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Card.outlined(
            child: InkWell(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const MyRequestsForApprovalScreen())),
              child: Padding(padding: const EdgeInsets.all(14),
