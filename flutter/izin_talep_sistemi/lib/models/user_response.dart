...
class UserResponse{
  ...
  UserResponse({required this.id, required this.firstName, required this.lastName, required this.email, required this.departmentName, required this.roleDisplayName, required this.roleAuthority});
